...
export const apiParityEntries: ApiParityEntry[] = [
  ...
  { functionName: 'assertMerchantAccess', method: 'GET', path: '/api/v1/merchant/access', authMode: 'merchant-session', planId: '09-04', testGroup: 'auth.routes' },
  ...
  { functionName: 'getMerchantUserDetail', method: 'GET', path: '/api/v1/merchant/users/:openid', authMode: 'merchant-session', planId: '09-05', testGroup: 'merchant-admin.routes' },
