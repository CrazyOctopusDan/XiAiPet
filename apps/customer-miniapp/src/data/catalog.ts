import type { CatalogCategory, CatalogProduct, HomeModule } from '../types/catalog';
...
export const homeModules: HomeModule[] = [
  {
    ...
    accent: '#F5C84C',
    imageFileId: '/assets/catalog/浏览商品_v3.jpg',
    imageAltText: '浏览商品'
  },
  {
    id: 'notice',
    ...
    accent: '#F1CFEC',
    imageFileId: '/assets/catalog/购前须知_3.jpg',
    imageAltText: '购前须知'
  },
  {
    id: 'consulting',
    ...
    accent: '#B9E16E',
    imageFileId: '/assets/catalog/售前咨询_v3.jpg',
    imageAltText: '售前咨询'
  },
  {
    id: 'vip',
    ...
    accent: '#F6D66C',
    imageFileId: '/assets/catalog/会员权益_v3.jpg',
    imageAltText: '会员权益'
  }
];
